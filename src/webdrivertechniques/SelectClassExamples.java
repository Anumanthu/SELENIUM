    ...
    public void selectDropDownValues() throws Exception
        {
            ...
            WebDriver driver=new ChromeDriver();
                      ...
                      //selectByValue("oct");
                       //   selectByVisibleText("oct");
                          ...
                          WebElement first_value=month.getFirstSelectedOption(); //It selects the default value on texbox
          ...
          String[] month_list= {"Month","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sept","Oct","Nov","Dec"};
                        	  ...
                        	  
                          {
                        	 ...
                        	 // System.out.println("dropdown values are "+it.next().toString()+"========"+it1.next().getText());
