...
public class Actions2ClassExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // WebElement
        // e2=driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']"));

        Actions ac = new Actions(driver);

        ac.moveToElement(e1).build().perform();

        WebDriverWait d = new WebDriverWait(driver, Duration.ZERO);
        ...
        //d.until(ExpectedConditions.urlContains("url");
